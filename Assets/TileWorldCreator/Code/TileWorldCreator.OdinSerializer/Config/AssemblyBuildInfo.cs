    ...
    public static class OdinSerializationBuiltSettingsConfig
    {
        ...
        public static OdinSerializationBuiltSettings Current
        {
            get
            {
                ...
                var group = BuildPipeline.GetBuildTargetGroup(_target);
                var _namedBuildTarget = NamedBuildTarget.FromBuildTargetGroup(group);
                var backend = PlayerSettings.GetScriptingBackend(_namedBuildTarget);
